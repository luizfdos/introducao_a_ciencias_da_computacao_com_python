...
def calcula_assinatura(texto):    
    ...
    for linha in range(len(palavras)):
        for coluna in range(len(palavras[linha])):
            nova_lista.append(palavras[linha][coluna])
    palavras = nova_lista[:]
    ...
    tamanho_medio_palavra = total_letras / num_tot_palavras
    type_token = n_palavras_diferentes(palavras) / num_tot_palavras
    hapax_legomana = n_palavras_unicas(palavras) / num_tot_palavras
    tamanho_medio_sentenca = soma_car_sentencas / total_sentencas
    complexidade_sentenca = num_frases / total_sentencas
    tamanho_medio_frase = soma_car_frases / num_frases
...
avalia_textos(textos, assinaturaMain)